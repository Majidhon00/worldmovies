...
<head>
    ...
    <title>Admin to world of movies</title>
    <!-- Favicon icon -->
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin1" data-sidebartype="full"
        data-sidebar-position="relative" data-header-position="relative" data-boxed-layout="full">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ route('rek.index') }}">
                                <i data-feather="users" class="feather-icon"></i>
                                <span class="hide-menu">Reklama</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ route('trailer.index') }}" aria-expanded="false">
